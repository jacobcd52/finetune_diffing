...
class TrainingConfig(BaseModel):
    ...
    contrastive_training_file: Optional[str] = Field(None, description="Optional JSONL file with the same dataset format as training_file, used for contrastive training")
